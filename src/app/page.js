...
export default function Home() {
  ...
  const hobbies = [
    ...
    },
    {
      name: "photography",
      size: "43M",
      content: <Hobby hobby={isNarrow ? "photography" : "natural photography"} description="highlights shot on a canon eos rebel t3i" media={photography} thumbnail="/img/photography/IMG_0804.JPG" modalType="gallery" />
    },
    {
      name: "poetry",
      size: "1.2G",
