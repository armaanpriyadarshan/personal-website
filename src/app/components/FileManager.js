          ...
          {getActiveSubdirectory() && (
            <>
              ...
              <div className="flex items-center justify-center relative md:hidden">
                <button
                  className={`absolute -left-8 top-1/2 pt-1.5 text-[var(--green)] text-2xl focus:outline-none bg-[var(--background)] ${activeIndex === 0 ? 'invisible' : ''} -translate-y-[2px] md:translate-y-0`}
                  style={{ zIndex: 2 }}
                  onClick={handlePrev}
                ...
                <button
                  className={`absolute -right-6 top-1/2 pt-1.5 text-[var(--green)] text-2xl focus:outline-none bg-[var(--background)] ${activeIndex === subdirectories.length - 1 ? 'invisible' : ''} -translate-y-[2px] md:translate-y-0`}
                  style={{ zIndex: 2 }}
                  onClick={handleNext}
